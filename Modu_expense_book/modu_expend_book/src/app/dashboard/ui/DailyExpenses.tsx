...
import ExpenseEntryDialog from '@/app/entry/ExpenseEntryDialog'
   ...
   return (
     <section className="bg-white mt-4 px-4 py-4 rounded-lg shadow-sm">
       <div className="flex justify-between items-center mb-4">
         ...
         <ExpenseEntryDialog 
  buttonStyle="px-4 py-2 bg-sky-500 text-white rounded-lg hover:bg-sky-600 transition-all text-sm"
  buttonText="+ 지출 등록"
/>
       </div>
 ...
 return (
   <div className={`bg-white p-6 rounded-lg shadow h-full overflow-auto ${className}`}>
     <div className="flex justify-between items-center mb-6">
       ...
       <ExpenseEntryDialog 
         buttonStyle="px-4 py-2 bg-sky-400 text-white rounded-lg hover:bg-sky-500 transition-colors text-sm"
         buttonText="+ 지출 등록"
       />
     </div>
     <div className="space-y-4">
